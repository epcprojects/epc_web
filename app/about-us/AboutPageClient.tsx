...
const AboutPageClient = () => {
  ...
  return (
    <div>
      <Hero2 />
      <div className="lg:bg-[#021210]">
        <div className="lg:rounded-t-[50px]! rounded-t-[32px]! lg:mt-0! -mt-10! overflow-hidden! bg-white">
          <div className="bg-white py-[32px]! lg:py-24! px-[16px]! lg:px-0!">
            <div className="container mx-auto max-w-7xl">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6! md:gap-12! items-center">
                <div className="space-y-[12px]! md:space-y-[20px]!">
                  <div className="flex flex-col items-start gap-[20px]!">
                    <div className="py-[8px]! px-[16px]! lg:px-[20px]! border! border-[#4939D2]! rounded-full flex flex-row items-center gap-[8px]!">
                      <PolygonIcon />
                  ...
                  <div className="space-y-[12px]! md:space-y-[24px]!">
                    <p className="text-gray-700  text-[16px]! lg:text-[20px]!">
      ...
      <div className="bg-black py-[32px]! lg:py-[96px]! bg-[url(/img/illustrations/industry.png)] h-full bg-no-repeat bg-top w-full">
        <div className="container mx-auto max-w-7xl relative overflow-hidden px-[16px]! lg:px-0!">
          <div className="mb-[20px]! lg:mb-[48px]!">
            <div className="flex flex-col items-center gap-4! md:gap-6!  lg:px-12!">
              <div className="py-[8px]! px-[16px]! lg:px-[20px]! border-b! bg-white/20 border-white! rounded-full flex flex-row items-center gap-[8px]!">
              ...
              <h2 className="text-[36px]! text-center lg:text-start lg:text-[48px]! leading-[120%]! font-semibold! text-white">
                Design trusted across{" "}
                <span className=" font-playfair ! ">every industry.</span>
              </h2>

              <p className="text-gray-300! text-center font-normal text-[16px]! lg:text-[20px]!">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4! md:gap-8! mb-[20px]! lg:mb-[52px]!">
            <div className="md:col-span-2 ">
              <div className="flex gap-4 mb-[8px]! lg:mb-4">
                <img
                  src="/img/services/SaaS1.jpg"
                  className="lg:h-[256px]! object-cover rounded-3xl!"
                  alt=""
                />
                <img
              ...
              <img
                ...
                className="lg:h-[408px]! object-cover rounded-3xl!"
                alt=""
              />
            </div>
      ...
      <div className="bg-[#FAF7F6] py-16! md:py-24!">
        <div className="container mx-auto max-w-7xl flex flex-col items-center justify-center gap-10! px-[16px]! lg:px-0!">
          <div className="flex flex-col items-center justify-center w-full gap-[20px]! pb-[16px]! lg:pb-[48px]!">
            ...
            <p className=" text-[36px]! lg:text-[48px]! leading-[120%]! font-semibold! text-gray-950">
              How we
              <span className=" font-playfair ! "> work.</span>
            </p>

            <p className="text-center text-gray-800! text-[16px]! lg:text-[18px]! w-10/12">
          ...
          <div className="max-w-[1120px] w-full space-y-[16px]! lg:space-y-[32px]!">
      ...
      <ParallaxBanner
        ...
        className="bg-[#FAF7F6] lg:pt-40!"
        videoUrl="https://res.cloudinary.com/dgbdcdqd1/video/upload/q_auto/f_auto/v1775646599/d_dcnt5q.mp4"
      />
      <div className="bg-[#FAF7F6] lg:pt-[96px]!">
        <Testimonials />
      </div>
      <div className="bg-[#FAF7F6]">
             <div className="container mx-auto max-w-7xl py-[24px]! md:py-[96px]!">
