...
export default function Hero() {
  return (
    <>
      <div className="md:mxd-section lg:pb-31! pt-12!  relative! flex flex-col md:justify-center md:items-center h-fit! md:mxd-hero-section lg:min-h-dvh md:mxd-hero-fullheight">
        <Image
